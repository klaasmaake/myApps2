...
package de.tobiasbielefeld.brickgames.goloi.ui;

import static de.tobiasbielefeld.brickgames.goloi.SharedData.NUMBER_OF_GAMES;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.TIMER_PAUSE;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.buttonKeyCodes;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.distanceHeight;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.distanceWidth;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.edit;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.gameView1;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.gameView2;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.getCurrentGame;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.highScores;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.input;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.look;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.mButtonPressed;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.mButtonPressedCounter;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.mainActivity;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.menu;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.params;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.savedData;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.soundList;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.sp;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.vibrate;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.vibration;
import static de.tobiasbielefeld.brickgames.goloi.SharedData.width;
import static de.tobiasbielefeld.brickgames.goloi.classes.Game.FIELD_HEIGHT;
import static de.tobiasbielefeld.brickgames.goloi.classes.Game.FIELD_HEIGHT_2;
import static de.tobiasbielefeld.brickgames.goloi.classes.Game.FIELD_WIDTH;
import static de.tobiasbielefeld.brickgames.goloi.classes.Game.FIELD_WIDTH_2;
...
import de.tobiasbielefeld.brickgames.goloi.classes.CustomAppCompatActivity;
import de.tobiasbielefeld.brickgames.goloi.classes.Game;
import de.tobiasbielefeld.brickgames.goloi.surfaceViews.GameView1;
import de.tobiasbielefeld.brickgames.goloi.surfaceViews.GameView2;
import de.tobiasbielefeld.brickgames.goloi.ui.about.AboutActivity;
/*
 *  Main activity which loads everything, handles the button input and contains the main loop
 */

public class Main extends CustomAppCompatActivity implements Runnable, View.OnTouchListener , View.OnClickListener{
   ...
   //     findViewById(R.id.buttonaware).setOnClickListener(this);
